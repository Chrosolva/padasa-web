...
@section('main-content')
	...
	<section class="content">
		<div class="box box-primary">
            <form role="form" method="POST" action="{{ url('/admin/modul') }}/{{ $modul->nama_modul }}/edit">
            	{{ csrf_field() }}
                <input type="hidden" name="_method" value="PUT">
				<div class="box-body">
					<div class="form-group {{ $errors->has('nama_modul') ? 'has-error' : '' }}">
                    	<label for="nama_modul">Nama Modul *</label>
						<input type="text" name="nama_modul" id="nama_modul" class="form-control" placeholder="Nama Modul" maxlength="50" value="{{ old('nama_modul', $modul->nama_modul) }}" required autofocus>
