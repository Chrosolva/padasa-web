                            ...
                            <table id="table-data2" class="table table-bordered table-striped table-hover datatable" >
                                <thead>
                                    <tr>
                                        <th style="font-size: 12px;">TGL</th>
                                        <th style="font-size: 12px;">KEBUN</th>
                                        <th style="font-size: 12px;">PEMASOK</th>
                                        <th style="font-size: 12px;">BERAT BERSIH(KG)</th>
                                        <th style="font-size: 12px;">JLH TRIP</th>
                                    </tr>
                                </thead>

                                <tbody>
                                    @foreach ($lhp_ProduksiTBSDetail as $row)
                                        <tr>
                                            <td>{{$row->TGL}}</td>
                                            <td>{{$namakebun}}</td>
                                            <td>{{$row->ORI_NAME}}</td>
                                            <td>{{number_format($row->BERATBERSIH,0,',','.')}}</td>
                                            <td>{{number_format($row->JLH_TRIP,0,',','.')}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
