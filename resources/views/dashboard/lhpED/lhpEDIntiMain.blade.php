    ...
    <section class="content">
        <div class="panel">
            <div class="panel-body">
                <form role="form" class="form-inline mb-2" method="GET" action="{{ url('/dashboard/lhpexecutive/lhpEDMainInti') }}">
                    <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            @else
                                                ...
                                                @if ($row->TELDA_REALISASI == 0)
                                                    <td class="bg-red" style="text-align: right;">{{number_format($row->TELDA_REALISASI,2,'.',',')}}</td>
                                                @else
                                                    <td style="text-align: right;">{{number_format($row->TELDA_REALISASI,2,'.',',')}}</td>
                                                @endif
                                            @endif
