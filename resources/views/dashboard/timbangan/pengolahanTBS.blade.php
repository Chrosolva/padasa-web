    ...
    <section class="content">
        <div class="panel">
            <div class="panel-body">
                <form role="form" class="form-inline" method="GET" action="{{ url('/dashboard/timbangan/pengolahan-tbs') }}">
            ...
            @for ($i = 0; $i < count($kebun); $i++)
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="chart">
                                <canvas id="areaChart_{{ $i }}" style="height:400px"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script-content')
    <script type="text/javascript">
        ...
        @for ($i = 0; $i < count($kebun); $i++)
            generateAreaChartJS('areaChart_{{ $i }}',
                [
                    @foreach ($pengolahan_tbs[$i] as $row)
