...
@section('main-content')
    <section class="content-header">
        <h1>
            Status Batch Per Bulan [IN DEVELOPMENT]
    ...
    <section class="content">
        <div class="panel">
            <div class="panel-body">
                <form role="form" class="form-inline" method="GET" action="{{ url('/dashboard/biofertilizer/Statusbatch') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date input-inline" style="width: 175px;">
                            ...
                            <input type="number" class="form-control" id="tahun" name="tahun" value="{{ Request::get('tahun') ?: date('Y', strtotime('0 days')) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date input-inline" style="width: 175px;">
                            ...
                            <input type="number" class="form-control" id="bulan" name="bulan" value="{{ Request::get('bulan') ?: date('m', strtotime('0 days')) }}">
                        </div>
                    </div>
                            ...
                            <table id="table-data" class="table table-bordered table-striped table-hover datatable" >
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size: 12px;">DATE BATCH</th>
                                        ...
                                        <th style="font-size: 12px;">ESTIMASI COMPOST</th>
                                        <th style="font-size: 12px;">KELUAR</th>
                                        <th style="font-size: 12px;">SALDO AKHIR</th>
                                        <th style="font-size: 12px;">STATUS</th>
                                ...
                                <tbody>
                                    @foreach ($Status_Batch as $row)
                                        <tr>
                                            <?php 
                                                $date = date_create($row->STARTCOMPOST);
                                                $date2 = date_create($row->DATE_BATCH);
                                                $flag = $row->FLAG;
                                            ?>
